...
def parse_args():
    ...
    parser.add_argument("--with_lora", type=int, default=1, help="Path to save the generated image")
    parser.add_argument("--steps", type=int, default=50, help="Path to save the generated image")
